<template>
  <header class="header">
    ...
    <div class="logo-container">
      <RouterLink to="/" class="flex items-center gap-3">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-8 h-8 md:w-10 md:h-10 text-white">
          <path stroke-linecap="round" stroke-linejoin="round" d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
        </svg>
        <div class="flex flex-col items-start">
          <div class="logo-text">Purple Dog</div>
          <span class="logo-subtitle">COLLECTION D'EXCEPTION</span>
        </div>
      </RouterLink>
    </div>
    ...
    <!-- Navigation à droite -->
    <nav class="flex flex-wrap gap-2 md:gap-4 items-center justify-end w-full md:w-auto order-2 md:order-0">
      <template v-if="isAuthenticated">
        <RouterLink to="/profile/userProfile" class="header-btn ">
      ...
      <template v-else>
        <RouterLink to="/auth/login" class="header-btn">
        ...
        <button @click="showRegisterModal = true" class="header-btn">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4">
      ...
      <RouterLink to="/favorites" class="header-btn" aria-label="Favoris">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4">
      ...
      <RouterLink to="/cart" class="header-btn" aria-label="Panier">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4">
  ...
  <nav class="nav-bar" :class="{ 'hidden md:flex': !isSecondaryOpen, 'flex': isSecondaryOpen }">
    <div class="w-full flex flex-col md:flex-row gap-4 md:gap-8 justify-center text-sm font-medium items-center md:items-center">
      ...
      <RouterLink to="/bijoux" class="router-nav flex items-center gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
      ...
      <RouterLink to="/autres" class="router-nav flex items-center gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
