  ...
  <header class="header">
    ...
    <div class="logo-container">
      <RouterLink to="/" class="flex items-center">
        <img src="@/assets/logo.png" alt="Purple Dog Logo" class="h-12 w-auto">
      </RouterLink>
    </div>
    ...
    <nav class="flex gap-6 items-center">
      ...
      <div class="relative" @mouseenter="showFavoritesPopup = true" @mouseleave="showFavoritesPopup = false">
        ...
        <!-- Popup au survol -->
        <div v-if="showFavoritesPopup" class="absolute right-0 top-full mt-4 w-80 bg-white shadow-xl rounded-lg p-6 transition-all duration-200 z-50">
